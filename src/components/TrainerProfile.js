...
const TrainerProfile = () => {
  ...
  function getme() {
    ...
    .then((res)=>{console.log(res);setTrainerDetail(res)})
    .then(()=>{
        console.log("details ",trainerDetail)
        trainerDetail.username=localStorage.getItem('username')
 ...
 <div class="container">
    <div class="main-body">
      ...
      <button className="hj"onClick={()=>getme}>click</button>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4>{trainerDetail.username}</h4>
                      <p class="text-secondary mb-1">Fitness Trainer</p>
                      <p class="text-muted font-size-sm">{trainerDetail.address}</p>
